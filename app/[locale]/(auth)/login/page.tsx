      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-primary p-12 text-primary-foreground relative overflow-hidden">
        ...
        <div className="relative z-10 mt-auto">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight mb-6 leading-tight">
            The next generation<br/>clinic management.
          </h1>
          <p className="text-lg text-primary-foreground/80 max-w-md">
            Streamline your operations, manage appointments, and elevate patient care with our state-of-the-art platform.
          </p>
        </div>
      </div>

      {/* Right side - Login Form */}
      <div className="flex w-full lg:w-1/2 items-center justify-center bg-background p-8 sm:p-12 relative overflow-hidden">
