...
export default function FinancialChart({ data, locale }: { data: any[], locale: string }) {
  ...
  return (
    <Card className="col-span-1 lg:col-span-2">
      <CardHeader>
        <CardTitle>{isAr ? 'الإيرادات مقابل المصروفات' : 'Income vs Expenses'}</CardTitle>
        <CardDescription>{isAr ? 'التفصيل الشهري للسنة الحالية' : 'Monthly breakdown for the current year'}</CardDescription>
      </CardHeader>
      <CardContent>
