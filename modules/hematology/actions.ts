...
export async function upsertHematologyNote(clinicId: string, locale: string, patientId: string, readings: any[]) {
  ...
  const { data: existingNote } = await supabase
    ...
    .eq('clinic_id', clinicId)
    .eq('note_type', 'hematology_tracker')
    .single()
