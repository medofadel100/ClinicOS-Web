...
export async function upsertPulmonologyNote(clinicId: string, locale: string, patientId: string, readings: any[]) {
  ...
  const { data: existingNote } = await supabase
    ...
    .eq('clinic_id', clinicId)
    .eq('note_type', 'pulmonology_tracker')
    .single()
