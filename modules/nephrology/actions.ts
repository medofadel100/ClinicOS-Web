...
export async function upsertNephrologyNote(clinicId: string, locale: string, patientId: string, readings: any[]) {
  ...
  const { data: existingNote } = await supabase
    ...
    .eq('clinic_id', clinicId)
    .eq('note_type', 'nephrology_tracker')
    .single()
