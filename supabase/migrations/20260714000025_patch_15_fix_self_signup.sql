-- Drop the NOT NULL constraint on plan_id since trial subscriptions might not have a plan yet
ALTER TABLE public.clinic_subscriptions ALTER COLUMN plan_id DROP NOT NULL;
